    ...
    window.RPGReactorWebHost = {
        ...
        async initialize() {
            ...
            window.require = moduleName => {
                ...
                throw new Error(tt('Node module "{moduleName}" is unavailable in Agonia Engine Web.', { moduleName }));
            };
        ...
        async saveFiles({ files, projectRoot = null, suggestedDirectoryName = 'Agonia Engine Export' }) {
            if (projectRoot) {
        ...
        unsupported(feature) {
            alert(tt('{feature} is available in the desktop edition of Agonia Engine. Browser edits are saved in this browser.', {
                feature: tt(feature),
            }));
        },
        applyBrowserUi() {
