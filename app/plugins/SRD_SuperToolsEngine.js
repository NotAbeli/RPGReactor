...
// [Фикс Korolev]: числовое сравнение версии NW.js
if((function(){var _v=(process.versions['node-webkit']||process.versions.nw||'0.0.0').split('.').map(function(s){return parseInt(s,10)||0;});return _v[0]>0||(_v[0]===0&&_v[1]>=13);})() && Utils.RPGMAKER_VERSION < "1.6.0") {
...
// [Фикс Korolev]: числовое сравнение версии NW.js (строковое ломается на NW.js >= 0.100)
(function(){var _v=(process.versions['node-webkit']||process.versions.nw||'0.0.0').split('.').map(function(s){return parseInt(s,10)||0;});_.isNewNWjs=(_v[0]>0||(_v[0]===0&&_v[1]>=13));})();
