    ...
    showWeaponDetail(container, weapon) {
        ...
        generalSection.innerHTML = `
            ...
            <div class="agn-insp-row">
                ...
                <div class="agn-insp-control" id="weapon-icon-container-${weapon.id}"></div>
            </div>
            <div class="agn-insp-row">
                <div class="agn-insp-label">${tt('Название')}</div>
                <div class="agn-insp-control"><input type="text" class="agonia-input" value="${rrEscapeHtml(weapon.name)}" data-field="name" data-weapon-id="${weapon.id}"></div>
            </div>
            <div class="agn-insp-row">
                <div class="agn-insp-label">${tt('Описание')}</div>
                <div class="agn-insp-control"><textarea class="agonia-input" rows="2" style="flex:1 1 100%;min-height:52px;resize:vertical;" data-field="description" data-weapon-id="${weapon.id}">${rrEscapeHtml(weapon.description)}</textarea></div>
            </div>
            <div class="agn-insp-row">
                <div class="agn-insp-label">${tt('Тип оружия')}</div>
                <div class="agn-insp-control"><select class="agonia-select" style="flex:0 1 320px;" data-field="wtypeId" data-weapon-id="${weapon.id}">
            ...
            <div class="agn-insp-row">
                ...
                <div class="agn-insp-control"><input type="number" class="agonia-input" value="${rrEscapeHtml(weapon.price || 0)}" data-field="price" data-weapon-id="${weapon.id}"></div>
            </div>
        `;
                ...
                <div class="agn-insp-row">
                    ...
                    <div class="agn-insp-control">
                        <input type="number" class="agonia-input" value="${rrEscapeHtml(params[idx] || 0)}"
                               data-field="params" data-param-index="${idx}" data-weapon-id="${weapon.id}">
                    </div>
                </div>
            `).join('')}
        `;
        ...
        noteSection.innerHTML = `
            ...
            <div class="agn-insp-row">
                ...
                <div class="agn-insp-control"><textarea class="agonia-input" rows="4" style="flex:1 1 100%;min-height:72px;resize:vertical;font-family:var(--font-mono,monospace);" data-field="note" data-weapon-id="${weapon.id}">${rrEscapeHtml(weapon.note)}</textarea></div>
            </div>
        `;
