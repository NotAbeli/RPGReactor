// Agonia Engine - Project Controller
...
class ProjectController {
    ...
    _readProjectLock(fs, lockPath) {
        ...
        try {
            ...
            if (!lock || lock.app !== 'Agonia Engine' || !Number.isInteger(lock.pid) || lock.pid <= 0 ||
    ...
    _rejectProjectLock(projectPath, error, live = false) {
        ...
        const message = live
            ? this._tt('This project is already open in another Agonia Engine instance.')
                ...
                if (projectPath) {
                    try {
                        ...
                        if (!loadedProject) {
                            ...
                            alert(this._tt("Failed to load project. Make sure it's a valid Agonia Engine or RPG Maker project.") + `\n\n${projectPath}${details}`);
    ...
    async installReactorRuntime() {
        ...
        alert(this._tt('Reactor runtime installed. Playtest and deployment now use the Agonia Engine engine.')
