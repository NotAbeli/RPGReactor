/**
 * ChangeLevelEditor - Editor for Change Level event command (code 316)
 */
class ChangeLevelEditor {
    ...
    createModal() {
        ...
        this.modal.className = 'change-level-editor-modal';
        ...
        container.className = 'change-level-container';
    ...
    renderContent() {
        ...
        levelUpCheckbox.id = 'show-level-up-316';
    ...
    createActorSelector() {
        ...
        fixedRadio.type = 'radio'; fixedRadio.name = 'actor-select-316'; fixedRadio.id = 'actor-fixed-316';
        ...
        varRadio.type = 'radio'; varRadio.name = 'actor-select-316'; varRadio.id = 'actor-variable-316';
    ...
    createOperationSection() {
        ...
        increaseRadio.name = 'operation-316';
        increaseRadio.id = 'increase-316';
        ...
        decreaseRadio.name = 'operation-316';
        decreaseRadio.id = 'decrease-316';
    ...
    createOperandSection() {
        ...
        constRadio.name = 'operand-type-316';
        constRadio.id = 'constant-316';
        ...
        const varRadio = document.createElement('input');
        varRadio.type = 'radio';
        varRadio.name = 'operand-type-316';
        varRadio.id = 'variable-316';
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChangeLevelEditor;
}
