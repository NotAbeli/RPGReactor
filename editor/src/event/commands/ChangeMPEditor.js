/**
 * ChangeMPEditor - Editor for Change MP event command (code 312)
 */
class ChangeMPEditor {
    ...
    createModal() {
        ...
        this.modal.className = 'change-mp-editor-modal';
        ...
        container.className = 'change-mp-container';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.change-mp-container');
        container.innerHTML = '';
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">${tt('Change MP')}</h3>
    ...
    createActorSelector() {
        ...
        fixedRadio.type = 'radio'; fixedRadio.name = 'actor-select-312'; fixedRadio.id = 'actor-fixed-312';
        fixedRadio.checked = (this.actorSelect === 0);
        fixedRadio.addEventListener('change', () => { this.actorSelect = 0; this.renderContent(); });
        const fixedLabel = document.createElement('label');
        fixedLabel.htmlFor = 'actor-fixed-312'; fixedLabel.textContent = tt('Fixed');
        ...
        varRadio.type = 'radio'; varRadio.name = 'actor-select-312'; varRadio.id = 'actor-variable-312';
        varRadio.checked = (this.actorSelect === 1);
        varRadio.addEventListener('change', () => { this.actorSelect = 1; this.renderContent(); });
        const varLabel = document.createElement('label');
        varLabel.htmlFor = 'actor-variable-312'; varLabel.textContent = tt('Variable');
    ...
    createOperationSection() {
        ...
        increaseRadio.name = 'operation-312';
        increaseRadio.id = 'increase-312';
        ...
        increaseLabel.htmlFor = 'increase-312';
        ...
        decreaseRadio.name = 'operation-312';
        decreaseRadio.id = 'decrease-312';
        ...
        decreaseLabel.htmlFor = 'decrease-312';
    ...
    createOperandSection() {
        ...
        constRadio.name = 'operand-type-312';
        constRadio.id = 'constant-312';
        ...
        constLabel.htmlFor = 'constant-312';
