(async function () {
    ...
    try {
        ...
        script.onerror = () => { throw new Error(tt('Could not load the Agonia Engine browser entry point.')); };
        document.body.appendChild(script);
    } catch (error) {
        console.error('Agonia Engine Web failed to start:', error);
        ...
        message.textContent = tt('Agonia Engine Web could not start: {error}', { error: error.message || error });
